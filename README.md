...
downloaded project
- Create a `.env` file in the root directory and add the following environments 
variable 
    - `PORT=3000`
...
```
 ## DB Design 
  ...
  ### Airport -> id , name , address , city_id , created_at , updated_at
      Relationship -> City has many airports and Airport belongs to a city (one to many reln)
  ```
